export default function EditIconGradient() {
  return (
    <div className="relative aspect-square rounded-[10px] inset-ring-[0.5px] shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),inset_0_1px_5px_rgba(255,255,255,0.1)] inset-ring-black/10 block shrink-0 bg-edit-gradient w-[3.125rem] h-[3.125rem]">
      <svg
        width="24"
        height="24"
